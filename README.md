...
+ This repository contains source code for WaterGAN devloped in [WaterGAN: Unsupervised Generative Network to Enable Real-time Color Correction of Monocular Underwater Images](https://arxiv.org/abs/1702.07392).
...
2) Train a model ([Pretrained models]())

3) Generate samples from an existing model
