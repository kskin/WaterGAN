...
class WGAN(object):
  def __init__(self, sess, input_height=640, input_width=480, input_water_height=1360, input_water_width=1024, is_crop=False,
         batch_size=64, sample_num = 64, output_height=256, output_width=256,
         y_dim=None, z_dim=100, gf_dim=64, df_dim=64,gfc_dim=1024, dfc_dim=1024, c_dim=3, max_depth=3.26,save_epoch = 25,
         water_dataset_name='default',air_dataset_name='default',
         depth_dataset_name='default',input_fname_pattern='*.png', checkpoint_dir='default', sample_dir=None,num_samples=4000):
    """
    ...
    self.sw = output_width
    self.sh = output_height
