...
flags.DEFINE_integer("input_height", 640, "The size of image to use")
...
flags.DEFINE_integer("save_epoch", 25, "Epoch number to save a snapshot")
FLAGS = flags.FLAGS
...
def main(_):
  ...
  with tf.Session(config=run_config) as sess:
    ...
    #                 [dcgan.h1_w, wgan.h1_b, wgan.g_bn1],
    #                 [dcgan.h2_w, wgan.h2_b, wgan.g_bn2],
    #                 [dcgan.h3_w, wgan.h3_b, wgan.g_bn3],
    #                 [dcgan.h4_w, wgan.h4_b, None])
